...
<form method="post" action="/_monitor/api" name="addAlertThreshold">
   <input type="hidden" name="method" value="addAlertThreshold">
   <div class="apiMethod">
      <div class="h3 apiMethodTitle">addAlertThreshold</div>
      <div class="apiParameter">
         <span class="label apiLabel">sensor_id</span>
         <input type="text" name="sensor_id" class="value input apiInput"/>
      </div>
      <div class="apiParameter">
         <span class="label apiLabel">operator</span>
         <input type="text" name="operator" class="value input apiInput"/>
      </div>
      <div class="apiParameter">
         <span class="label apiLabel">value</span>
         <input type="text" name="value" class="value input apiInput"/>
...
<form method="post" action="/_monitor/api" name="editAlertThreshold">
   <input type="hidden" name="method" value="editAlertThreshold">
   <div class="apiMethod">
      <div class="h3 apiMethodTitle">editAlertThreshold</div>
      <div class="apiParameter">
...
<form method="post" action="/_monitor/api" name="removeAlertThreshold">
   <input type="hidden" name="method" value="removeAlertThreshold">
   <div class="apiMethod">
      <div class="h3 apiMethodTitle">removeAlertThreshold</div>
      <div class="apiParameter">
         <span class="label apiLabel">id</span>
         <input type="text" name="id" class="value input apiInput"/>
      </div>
