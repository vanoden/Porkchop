...
<section class="faq">
	<ul class="form-grid page_3col_wide-right">
		<li>
			<h3>1. Verify your information</h3>
			<ol>
...
<section class="faq">
	<ul class="form-grid page_3col_wide-right">
		<li>
			<h3>2. Choose monitor for service</h3>
			<ol>
...
<section class="faq">
	<ul class="form-grid page_3col_wide-right">
		<li>
			<h3>3. Create a Support Ticket</h3>
			<ol>
...
<section class="faq">
	<ul class="form-grid page_3col_wide-right">
		<li>
			<h3>4. Confirm New Support Ticket</h3>
...
<section class="faq">
	<ul class="form-grid page_3col_wide-right">
		<li>
			<h3>5. RMA created by Spectros Instruments</h3>
			<ol>
...
<section class="faq">
	<ul class="form-grid page_3col_wide-right">
		<li>
			<h3>7. Complete and Submit RMA Form</h3>
			<ol>
...
<section class="faq">
	<ul class="form-grid page_3col_wide-right">
		<li>
		<h3>8. Your return is processing</h3>
			<ol>
...
<section class="faq">
	<ul class="form-grid page_3col_wide-right">
		<li>
			<h3>9. Your return request was received. Prepare items to Ship</h3>
...
<section class="faq">
	<ul class="form-grid page_3col_wide-right">
		<li>
			<h3>10. How to Package Your Monitor for Shipping</h3>
			<h4>Ship each individual monitor using<sup>1</sup>:</h4>
			<ul>
			...
			<p class="notice_warning">NO multizone monitor will be accepted for repair if it is shipped without packaging, whether or not it is inside a cardboard box or hard-shell case.</p>
			<h4>Acceptable packaging materials include:</h4>
			<ul>
		...
		<li>
			...
			<h4>Suggested packaging material<sup>2</sup>:</h4>
			<ul>
				<li>Bubble wrap: 
					<a href="https://bit.ly/3zO9fKI">U-Line</a> | 
					<a href="https://bit.ly/3QlX8f2">Paper Mart</a> | 
					<a href="https://amzn.to/3Pi6jeS">Amazon</a>
				</li>
				<li>Kraft paper: 
					<a href="https://bit.ly/3JNfWBq">U-Line</a> | 
					<a href="https://bit.ly/3BSnwbS">Paper Mart</a> | 
					<a href="https://amzn.to/3QebqhB">Amazon</a>
				</li>
				<li>Packing tape: 
					<a href="https://bit.ly/3C44f7c">Staples</a> | 
					<a href="https://bit.ly/3BVzG3z">Paper Mart</a> | 
					<a href="https://amzn.to/3dkZwE5">Amazon</a>
				</li>
			</ul>
