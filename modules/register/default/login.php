...
<? } ?>
			<div id="register_important" style="width: 100%; padding: 0px;">
				<span class="label labelImportant" style="width: 100%; clear: both; display: block; padding: 0px;">Important</span>
				<span class="value" style="width: 100%; clear: both; display: block; padding: 0px;">This site is for authorized use by employees and customers of <r7 object="company" property="name"/>. No other use is permitted.</span>
			</div>
			...
			<div id="register_submit">
				<input class="button buttonRegisterLogin" type="submit" name="submit" value="Login"/>
			</div>
			<div id="forgot_link" style="width: 100%; padding: 0px;">
			    <a id="recover_password_link" href="/_register/forgot_password">
				Recover Password
			    </a>
			    <a id="registration_link" href="<?=PATH?>/_contact/form">
				Sign Up
			    </a>
			</div>
		</div>
