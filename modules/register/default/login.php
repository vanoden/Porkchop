...
<? } ?>
			<div id="register_important">
				<p class="value form_instruction"><span class="form_important">Important</span><br>This site is for authorized use by employees and customers of <r7 object="company" property="name"/>. No other use is permitted.</p>
			</div>
