...
<section id="reg_form" class="body">
	...
	<?php } ?>
		<form name="register" id="register_form" action="<?= PATH ?>/_register/org_account" method="POST">
		...
		<?php if ($repository->id) { ?>
			<section class="form-group image-upload">
				<form name="repoUpload" action="/_register/org_account/<?= $customer->code ?>" method="post"
		...
		<form id="delete-contact" name="delete-contact" action="<?= PATH ?>/_register/org_account" method="post"
			class="hidden-form">
			<input type="hidden" name="csrfToken" value="<?= $GLOBALS['_SESSION_']->getCSRFToken() ?>">
