<?php
/** @view /_register/org_account
 * Organization Admin view of A User's Account for Admin Purposes
 */
$porkchop = new \Porkchop();
$site = $porkchop->site();
$page = $site->page();
$page->requirePrivilage('manage customers',\Register\PrivilegeLevel::ORGANIZATION_MANAGER);
