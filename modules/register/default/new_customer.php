...
<form name="register" action="/_customer/register" method="POST">
   ...
   <div id="registerFormSubmit">
      <div class="form-group">
         <div id="registerCompanyName">
            ...
            <input type="text" class="value registerValue long-field" name="organization_name" value="<?=$_REQUEST['first_name']?>" placeholder="Company LLC"/>
        ...
        <div id="product_details" style="display:none;">  
            ...
            <input type="text" id="serial" class="long-field" name="serial" placeholder="SF8TA1001">
            ...
            <select id="product_id" name="product_id" class="value input collectionField" onchange="updateReport()">
	             <option value="ALL"<? if ($product == $selectedProduct) print " selected"; ?>>---</option>
         ...
         <input type="text" id="city" name="city" placeholder="555-555-5555">
         <label for="state">Cell</label>
         <input type="text" id="city" name="city" placeholder="555-555-5555"><br/>
         <h3>Contact Info</h3>
         <span class="label registerLabel registerFirstNameLabel">*First Name:</span>
         <input type="text" class="value registerValue registerFirstNameValue long-field" name="first_name" value="<?=$_REQUEST['first_name']?>" placeholder="John">
         <span class="label registerLabel registerLastNameLabel">*Last Name:</span>
         <input type="text" class="value registerValue registerLastNameValue long-field" name="last_name" value="<?=$_REQUEST['last_name']?>" placeholder="Doe">
         ...
         <input type="text" class="value registerValue registerLoginValue" name="work_email" value="<?=$_REQUEST['work_email']?>" placeholder="me@business.com">
         <span class="label registerLabel registerLoginLabel">*Home Email:</span>
         <input type="text" class="value registerValue registerLoginValue" name="home_email" value="<?=$_REQUEST['home_email']?>" placeholder="me@email.com">
      </div>
