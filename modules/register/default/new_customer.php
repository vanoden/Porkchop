...
<script type="text/javascript" src="/includes/register-new-customer.js"></script>
  ...
  <form name="register" action="/_register/new_customer" method="POST">
    ...
    <ul class="form-grid four-col connectBorder">
      ...
      <li id="product_type" class="register-new-customer-product-type" style="display: none;"> 
        ...
        <select id="product_id" name="product_id" class="value input collectionField register-new-customer-product-select" onchange="var w=document.getElementById('serial_number_messages'); var e=document.getElementById('serial_number_message'); var o=document.getElementById('serial_number_message_ok'); if(w) w.style.display='none'; if(e) e.style.display='none'; if(o) o.style.display='none';">
    ...
    <div id="serial_number_messages" class="register-new-customer-serial-message" style="display: none;" aria-live="polite">
