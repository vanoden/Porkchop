...
<style>
  .icon_story { max-width: 250px; }
  .form-grid li {  padding: .3rem 0; display: flex; flex-direction: column; align-items: center; }
...
<h2 class="pageSect_full">Thank you</h2>
  <ul class="form-grid sub_2col">
    ...
    <li>
      <img src="/img/icons/icon_portal_spam.png" class="icon_story">
      <div>
