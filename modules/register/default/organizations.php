...
<form id="orgSearch" method="get" class="monitor-admin-list register-organizations">
...
<?php	} ?>
		...
		<div class="form-field form-field--checks register-organizations-filter-checks">
...
<?php	if (is_array($organizations) && count($organizations)) {
		foreach ($organizations as $organization) { ?>
			<tr>
				<td data-label="ID"><a href="<?=PATH."/_register/organization?organization_id=".$organization->id?>"><?=htmlspecialchars($organization->code)?></a></td>
