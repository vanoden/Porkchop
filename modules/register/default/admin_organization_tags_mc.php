<?php
	...
	// Security - Only Administrators can see other customers
	if ($GLOBALS['_SESSION_']->customer->can('manage customers')) {
		...
		elseif (isset($GLOBALS['_REQUEST_']->query_vars_array[0]) && preg_match('/^\w[\w\-\.\_]*$/',$GLOBALS['_REQUEST_']->query_vars_array[0])) {
