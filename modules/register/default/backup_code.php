  ...
  <section class="margin-top-0">
    ...
    <div class="pageSect_full pad_vert-sm">
      <form method="post" action="/_register/backup_code" class="pageSect_full">
        ...
        <input type="text" id="backup_code" name="backup_code" required placeholder="Enter your backup code" class="long-field input-max-width-350 margin-bottom-1em">
        <br>
        <input type="hidden" name="csrfToken" value="<?= $GLOBALS['_SESSION_']->getCSRFToken() ?>">
        <input type="submit" class="button" value="Login with Backup Code">
      </form>
    </div>
    <div class="pageSect_full pad_vert-sm text-align-center">
