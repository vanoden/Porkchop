<a href="/_package/packages">Back to Packages</a>
<?  if ($package->id) { ?>
<div class="title">Package <?=$package->code?></div>
<a href="/_package/versions?package_id=<?=$package->id?>">Package Versions</a>
<?  } else { ?>
...
<div class="container">
    ...
    <input type="text" name="code" class="value input" value="" />
</div>
<?  } ?>
<div class="container">
    <span class="label">Name</span>
    <input type="text" name="name" class="value input" value="<?=$package->name?>" />
</div>
<div class="container">
    <span class="label">Description</span>
    <textarea name="description" class="value input"><?=$package->description?></textarea>
</div>
<div class="container">
    <span class="label">License</span>
    <input type="text" name="license" class="value input" value="<?=$package->license?>" />
</div>
<div class="container">
    <span class="label">Owner</span>
    <select name="owner_id" class="value input">
...
?>
    <select name="repository_id" class="value input">
