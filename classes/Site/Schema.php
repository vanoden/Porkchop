			...
			if ($this->version() < 2) {
				...
				$create_table_query = "
					CREATE TABLE IF NOT EXISTS `session_sessions` (
					  ...
					  `last_hit_date` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
					  `first_hit_date` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
				...
				$create_table_query = "
					CREATE TABLE IF NOT EXISTS `session_hits` (
					  ...
					  `hit_date` datetime NOT NULL DEFAULT '1001-01-01 00:00:00',
